...
sen2vec = Reshape((sent_maxlen, sent_maxlen, 1))(model_input)
sen2vec_cnn = Conv2D(filters=4, kernel_size=(3, 3), padding='valid', activation='tanh')(sen2vec)
...
print 'end training!'
print 'save model!'
model.save('../model/CNNGRUPC_model.h5')
